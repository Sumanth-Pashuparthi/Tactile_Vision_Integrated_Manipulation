...
public:
    CombinedPointCloudProcessor() : Node("combined_pointcloud_processor")
    {
        pointcloud_subscription_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
            "/realsense2/points", 10,
            std::bind(&CombinedPointCloudProcessor::pointCloudCallback, this, std::placeholders::_1));

        transformed_pointcloud_publisher_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/transformed_pointcloud_data2", 10);
        processed_pointcloud_publisher_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("segmented_plane2", 10);
...
private:
    void pointCloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr cloud_msg)
    {
        ...
        try
        {
            transform_stamped = tf_buffer_->lookupTransform("world", "camera_link2", tf2::TimePointZero);
        }
        ...
        pass_z.setFilterLimits(0.9, 2.25);
        ...
        // Add this just before publishing the final cloud (after clustering)
